...
const Home = props => (
	<Panel id={props.id}>
		...
		{Object.keys(props.mockedUser).length > 0 &&
		<Group title="Mocked User Data">

			<Div>
				<Entity
					photo={props.mockedUser.photo_200}
					size={48}
					title={`${props.mockedUser.first_name} ${props.mockedUser.last_name}`}
					description={props.mockedUser.city.title}
				/>
			</Div>
